        ...
        <form wire:submit.prevent="submit">
            ...
            <div class="mt-6 bg-prims-yellow-1 rounded-lg p-4">
                ...
                <div class="mt-6">
                    ...
                    <textarea wire:model="allergies" class="w-full border p-2 rounded" placeholder="Allergies..." required></textarea>
                            ...
                            @foreach ($past_medical_history as $key => $value)
                                @if ($key === 'Hepatitis')
                                    <div class="flex flex-col my-2">
                                        <span class="font-bold text-lg" required>{{ $key }}</span>
                        ...
                        <div class="text-md grid grid-cols-2 md:grid-cols-4 gap-4 m-4">
                            ...
                            <div class="col-span-2 flex flex-col">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <input type="number" wire:model="social_history.sticks_per_day" class="border rounded p-1 w-20" min="0" required>
                                    <label class="text-md">Packs/year:</label>
                                    <input type="number" wire:model="social_history.packs_per_year" class="border rounded p-1 w-20" min="0" required>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col">
                                ...
                                <select wire:model="social_history.alcohol" class="border rounded p-1 w-full" required>
                            ...
                            <div class="col-span-2 flex flex-col">
                                ...
                                <input type="text" wire:model="social_history.medications" class="border rounded-md p-1 w-[23.15rem]" required>
                            </div>
                ...
                <textarea wire:model="pe" class="w-full border p-2 rounded mt-2 mb-1" placeholder="Physical Examination" required></textarea>

                <label class="block text-lg font-medium">Diagnosis</label>
                <select wire:model="diagnosis" class="w-full p-2 border rounded-md mb-4" required>
                ...
                <textarea wire:model="prescription" class="w-full border p-2 rounded mb-1" placeholder="Prescription" required></textarea>
